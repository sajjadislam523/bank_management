...
class UserRegistrationForm(UserCreationForm):
    ...
    gender = forms.ChoiceField(choices=constants.GENDER_TYPE)
    ...
    class Meta:
        ...
        fields = ['username', 'password1', 'password2', 'first_name', 'last_name',
                  'email', 'account_type', 'date_of_birth', 'gender', 'postal_code', 'city', 'street_address', 'country']

    def save(self, commit=True):
        user = super().save(commit=False)  # Ami ekhon database e data save korbona!!!
        if commit is True:
            user.save()
